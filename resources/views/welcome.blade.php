...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200 p-4">
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            <h1 class="font-bold text-5xl text-center mb-8">laravel plus Tailwind</h1>
            ...
            <div class="mb-6">
                <form class="flex flex-col space-y-4" method="POST" action="/">
                    ...
                    <textarea name="description" placeholder="The todo description" aria-atomic=""class="py-3 px-4 bg-gray-100 rounded-xl" ></textarea>
